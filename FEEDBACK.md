...
- The comment for each function does not have the purpose the parameter or the return type. 
- Although I can navigate through the menu options, they are difficult to understand. 
- The line function does not correspond to the requirement in read me file. 
